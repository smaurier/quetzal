...
-- AddForeignKey
ALTER TABLE "TenantModule" ADD CONSTRAINT "TenantModule_moduleSlug_fkey" FOREIGN KEY ("moduleSlug") REFERENCES "Module"("slug") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TenantModule" ADD CONSTRAINT "TenantModule_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AuditLog" ADD CONSTRAINT "AuditLog_userId_fkey" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- Whitelist locale values
ALTER TABLE "user"
  ADD CONSTRAINT "user_locale_valid" CHECK ("locale" IN ('fr', 'en', 'es'));

-- Whitelist member role values
ALTER TABLE "member"
